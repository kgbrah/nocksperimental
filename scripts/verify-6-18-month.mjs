...
const trustUpdateRegistryAuthLib = readText("src/lib/trust-update-registry-auth.ts");
...
expectIncludes(trustUpdateRegistryAuthLib, "NOCKS_REGISTRY_UPDATE_KEY", "trust update protected API");
expectIncludes(trustUpdateRegistryAuthLib, "NOCKS_REGISTRY_UPDATE_KEYS", "trust update protected API key rotation");
expectIncludes(trustUpdateRegistryAuthLib, "x-nocks-registry-key-id", "trust update protected API key id header");
expectIncludes(trustUpdateRegistryAuthLib, "safeCompareSecrets", "trust update protected API timing-safe auth");
expectIncludes(trustUpdatesApi, "authenticateRegistryUpdate", "trust update protected API auth helper");
...
expectIncludes(trustUpdateRegistryAuthLib, "x-nocks-registry-key-id", "trust update audit reader key id header");
expectIncludes(trustUpdateAuditApi, "authenticateRegistryUpdate", "trust update audit reader auth helper");
