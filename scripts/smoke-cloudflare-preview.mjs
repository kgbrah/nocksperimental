...
async function main() {
  ...
  try {
    ...
    await expectStatus(`${baseUrl}/api/nockchain/hoon-kernels`, 200, "Nockchain Hoon kernel and jam atlas");
    ...
    await expectStatus(`${baseUrl}/api/nockchain/testkit-e2e`, 200, "Nockchain testkit and E2E source trace");
    ...
    await expectStatus(`${baseUrl}/api/nockchain/mining-source`, 200, "Nockchain mining and PoW source trace");
    ...
    await expectStatus(`${baseUrl}/nockchain/hoon-kernels`, 200, "Nockchain Hoon kernel atlas page");
    ...
    await expectStatus(`${baseUrl}/nockchain/testkit-e2e`, 200, "Nockchain testkit/E2E page");
    ...
    await expectStatus(`${baseUrl}/nockchain/mining/source`, 200, "Nockchain mining and PoW source page");
