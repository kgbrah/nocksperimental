...
| 2 | **AI Compute Market (Fork A)** | PLANNED Jun 2026 | Matmul PoUW merge-mined alongside zkPoW; difficulty check moves inside formula execution | Miner/pool economics (golden-miner), "proving demand" evidence packs; first concrete useful-work market | Roadmap; `compute-markets` docs page (Fork A signal); Zorp announcements |
