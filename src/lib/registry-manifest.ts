...
export const registryEndpoints = [
  ...
  {
    id: "nockchain-runtime-safety",
    path: "/api/nockchain/runtime-safety",
  ...
  {
    id: "nockchain-api-source-trace",
    path: "/api/nockchain/api-source",
    description: "Nockchain public API source trace"
  },
  {
    id: "nockchain-watch",
  ...
  {
    id: "nockchain-impact-queue",
    path: "/api/nockchain/impact",
    description: "Nockchain upstream impact queue"
  },
  {
